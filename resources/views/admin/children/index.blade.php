        ...
        <div class="bg-gradient-to-r from-blue-50 to-white px-8 py-6 border-b border-blue-100">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h3 class="text-2xl font-bold text-gray-800">Semua Anak</h3>
                        <p class="text-sm text-gray-600">Pantau semua data anak terdaftar</p>
                    </div>
                </div>
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    ...
                    <div class="flex items-center gap-4 px-4 py-2 bg-blue-50 rounded-xl">
                        <div class="text-center">
                            <p class="text-xs text-gray-600">Total Anak</p>
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-blue-50/50 transition-colors">
                        ...
                        <td class="px-6 py-4">
                            ...
                            @if($child->blood_type)
                                <p class="text-xs text-gray-500">Gol Darah: {{ $child->blood_type }}</p>
                            @endif
                        </td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4">
                            ...
                            <p class="text-xs text-gray-500">({{ $child->age_in_months }} bulan)</p>
                        </td>
                        <td class="px-6 py-4">
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-green-100 text-green-700">
                                {{ $child->growth_records_count }} catatan
                            </span>
                        </td>
                    ...
                    <tr>
                        <td colspan="9" class="px-6 py-12 text-center text-gray-500">
                            ...
                            <p class="text-lg font-semibold">Tidak ada data anak</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
