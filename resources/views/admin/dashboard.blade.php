<x-app-layout>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl shadow-xl p-6 text-white transform hover:scale-105 transition-all duration-300">
            ...
            <a href="{{ route('admin.users') }}" class="text-xs text-blue-200 hover:text-white mt-2 inline-block">View all →</a>
        </div>
        ...
        <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-2xl shadow-xl p-6 text-white transform hover:scale-105 transition-all duration-300">
            ...
            <p class="text-green-100 font-medium">Total Children</p>
            <a href="{{ route('admin.children') }}" class="text-xs text-green-200 hover:text-white mt-2 inline-block">View all →</a>
        </div>
        ...
        <div class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl shadow-xl p-6 text-white transform hover:scale-105 transition-all duration-300">
            ...
            <p class="text-purple-100 font-medium">Growth Records</p>
            <a href="{{ route('admin.growth-records') }}" class="text-xs text-purple-200 hover:text-white mt-2 inline-block">View all →</a>
        </div>
        ...
        <div class="bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl shadow-xl p-6 text-white transform hover:scale-105 transition-all duration-300">
            ...
            <p class="text-orange-100 font-medium">Body Analyses</p>
            <a href="{{ route('admin.analyses') }}" class="text-xs text-orange-200 hover:text-white mt-2 inline-block">View all →</a>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div class="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-blue-100 p-6">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-600 font-medium">Today's Analyses</p>
        ...
        <div class="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-blue-100 p-6">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-600 font-medium">Active Users (30d)</p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        ...
        <div class="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-blue-100 overflow-hidden">
            <div class="bg-gradient-to-r from-blue-50 to-white px-6 py-4 border-b border-blue-100 flex items-center justify-between">
                ...
                <a href="{{ route('admin.activity-logs') }}" class="text-sm text-blue-600 hover:text-blue-700">View all →</a>
            </div>
    ...
    <div class="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-blue-100 overflow-hidden">
        <div class="bg-gradient-to-r from-blue-50 to-white px-6 py-4 border-b border-blue-100 flex items-center justify-between">
            ...
            <a href="{{ route('admin.analyses') }}" class="text-sm text-blue-600 hover:text-blue-700">View all →</a>
        </div>
            ...
            <table class="w-full">
                <thead class="bg-gray-50 border-b-2 border-gray-200">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-bold text-gray-700 uppercase">Photo</th>
                        <th class="px-6 py-3 text-left text-xs font-bold text-gray-700 uppercase">Height</th>
                        <th class="px-6 py-3 text-left text-xs font-bold text-gray-700 uppercase">Weight</th>
