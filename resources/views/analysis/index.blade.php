...
<body class="bg-gray-100 min-h-screen py-10">
    ...
    <div class="max-w-4xl mx-auto px-4">
        ...
        <div class="text-center mb-10">
            <h1 class="text-3xl font-bold text-blue-600">🤖 Analisis Tubuh AI</h1>
            <p class="text-gray-600 mt-2">Unggah foto, server akan mencatat estimasi Tinggi, Berat & Umur.</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="bg-white p-6 rounded-xl shadow-md">
                ...
                <form action="{{ route('analysis.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        <label class="block text-gray-700 text-sm font-bold mb-2">Pilih Foto Seluruh Tubuh</label>
            ...
            <div class="bg-blue-50 p-6 rounded-xl border border-blue-100">
                ...
                <ul class="list-disc list-inside text-sm text-gray-700 space-y-2">
                    <li>Foto diunggah ke folder <code>storage/app/public/uploads</code>.</li>
        ...
        <div class="mt-10 bg-white p-6 rounded-xl shadow-md">
            <h2 class="text-xl font-bold mb-4">📂 Riwayat Analisis</h2>
                ...
                <table class="min-w-full text-left text-sm">
                    <thead class="bg-gray-50 border-b">
                        <tr>
                            ...
                            <th class="p-3">Tinggi (Estimasi)</th>
                            <th class="p-3">Berat (Estimasi)</th>
                            <th class="p-3">Umur (Estimasi)</th>
